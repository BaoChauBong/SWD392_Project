 ...
 * @author Admin
 */
public class AdminDeleteTestProject extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //execute delete
        boolean check = testProjectDao.deleteTestProject(name);
        if (check == true) {
        ...
        //set attribute and send to servler adminaccountlist
        request.getRequestDispatcher("listTestProject").forward(request, response);
    }
