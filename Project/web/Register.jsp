        ...
        <form action="signup" class="form-register">
            ...
            <div class="user-details">
                ...
                <div class="input-box">
                    ...
                    <input value="${firstname}" name="firstname" type="text" placeholder="Enter your first name" required>
                </div>
                <div class="input-box">
                    <span class="details">Last Name</span>
                    <input value="${lastname}" name="lastname" type="text" placeholder="Enter your last name" required>
                </div>
                <div class="input-box">
