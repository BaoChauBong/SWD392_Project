<%-- 
    Document   : SeniorHomepage
    Created on : 06-Nov-2022, 14:09:00
    Author     : Admin
--%>
    ...
    <body>
        ...
        <aside class="sidebar position-fixed top-0 left-0 overflow-auto h-100 float-left" id="show-side-navigation1">
            ...
            <div class="sidebar-header d-flex justify-content-center align-items-center px-3 py-4">
                ...
                <div class="ms-2">
                    <h5 class="fs-6 mb-0">
                        <a class="text-decoration-none" href="#">Senior Tester                        
            ...
            <!--menu sidebar-->
            <%@include file="template/seniorMenu.jsp" %>
        </aside>
        <!--main content-->
        <section id="wrapper">
            <!--header-->
            ...
            <div class="p-4">
                ...
                <div class="container-header">
                    <h1>Welcome back
                        <span class="txt-type" data-wait="3000" data-words='[", Senior Tester", ", Glad to meet you"]'></span>
                    </h1>
