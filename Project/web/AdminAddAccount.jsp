                        ...
                        <form action="adminaccountadd" method="post">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="${account.firstname}" name="firstname" type="texte" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Last name</label>
                                    <input value="${account.lastname}" name="lastname" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
