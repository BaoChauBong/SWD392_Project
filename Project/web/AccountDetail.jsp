                ...
                <div class="col-xl-4">
                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <img class="img-account-profile rounded-circle mb-2" src="${pageContext.request.contextPath}/assets/avatars/tavantan.jpg" alt="">                         
                            ...
                            <form action="accountedit" method="post">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="firstname" class="form-control" type="text" placeholder="Enter your first name" value="${sessionScope.acc.getFirstname()}" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="small mb-1">Last Name</label>
                                        <input name="lastname" class="form-control" type="text" placeholder="Enter your last name" value="${sessionScope.acc.getLastname()}" readonly>
                                    </div>
                                </div>
                                <!-- Form Row        -->
                                <div class="row gx-3 mb-3">
